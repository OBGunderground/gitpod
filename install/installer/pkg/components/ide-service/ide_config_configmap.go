...
func ideConfigConfigmap(ctx *common.RenderContext) ([]runtime.Object, error) {
	...
	gitpodWebImage := ctx.ImageName(ctx.Config.Repository, ide.GitpodWebImage, ctx.VersionManifest.Components.Workspace.GitpodWebImage.Version)
